            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.product_category.create') }}" class="btn btn btn-secondary"><i
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>{{ $category->name }}</td>
                                        <td>{{ $category->code }}</td>
                                        <td>{{ $category->internal_code }}</td>
                                        <td>{{ $category->group->name }}</td>
                                        <td>
                                            @if ($category->show_as_featured == 1)
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-danger delete_record"
                                                data-url="{{ route('admin.product_category.destroy', $category->id) }}"><i
