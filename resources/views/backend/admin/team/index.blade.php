            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.team.create') }}" class="btn btn btn-secondary"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body ">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <a href="{{ route('admin.team.index') }}" class="btn btn-lg btn-default">
                            ...
                            <tbody>
                                @foreach ($teams as $team)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $team->name }}</td>
                                        <td>{{ $team->designation?$team->designation->name:'' }}</td>
                                        <td>
                                            @if ($team->is_active == 1)
                                        ...
                                        <td>
                                            <a href="{{ route('admin.team.edit', $team->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-sm btn-danger delete_record" data-url="{{ route('admin.team.destroy', $team->id) }}"><i class="fas fa-trash"></i></a>
