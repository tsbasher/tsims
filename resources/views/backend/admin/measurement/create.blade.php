    ...
    <section class="content">
            <div class="row">
                    ...
                    <div class="card card-body bg-gray-light">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" action="{{ route('admin.measurement.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" name="name" id="name" placeholder="Enter Measurement Name" value="{{ old('name') }}">
                                        </div>
                                    </div>                                  
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="code">Measurement Code</label>
                                            <input type="text" required class="form-control" name="code" id="code" placeholder="Enter Measurement Code" value="{{ old('code') }}">
                                        </div>
                                    </div>                                    
                                </div>
