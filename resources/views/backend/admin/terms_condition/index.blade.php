            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.terms_condition.create') }}" class="btn btn btn-secondary"><i
                            ...
                            <tbody>
                                @foreach ($conditions as $condition)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.terms_condition.edit', $condition->id) }}"
                                                class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-sm btn-danger delete_record"
                                                data-url="{{ route('admin.terms_condition.destroy', $condition->id) }}"><i
