            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.product_group.create') }}" class="btn btn btn-secondary"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body ">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <a href="{{ route('admin.product_group.index') }}" class="btn btn-lg btn-default">
                            ...
                            <tbody>
                                @foreach ($groups as $group)
                                    <tr>
                                        ...
                                        <td>{{ $group->name }}</td>
                                        <td>{{ $group->code }}</td>
                                        <td>{{ $group->internal_code }}</td><td>
                                            @if ($group->show_as_featured == 1)
                                        ...
                                        <td>
                                            <a href="{{ route('admin.product_group.edit', $group->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-sm btn-danger delete_record" data-url="{{ route('admin.product_group.destroy', $group->id) }}"><i class="fas fa-trash"></i></a>
