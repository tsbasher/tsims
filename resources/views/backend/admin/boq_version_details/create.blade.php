                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="scheme_option_id" placeholder="Scheme Option" name="scheme_option_id" required>
                                    ...
                                    <option value="{{ $option->id }}" @if(old('scheme_option_id',$boq_version?$boq_version->scheme_option_id:null)==$option->id) selected @endif>{{ $option->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boq_item_id" id="boq_item_id" placeholder="Enter BOQ Item" required>
                                    ...
                                    <option value="{{ $boq_item->id }}" data-sub_item="{{$boq_item->has_sub_items}}" @if (old('boq_item_id')==$boq_item->id) selected @endif>{{$boq_item->code}}.{{ $boq_item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boq_sub_item_id" id="boq_sub_item_id" placeholder="Enter BOQ Sub Item">
                                    ...
                                    <option value="{{ $boq_sub_item->id }}" @if (old('boq_sub_item_id')==$boq_sub_item->id) selected @endif>{{$boq_sub_item->code}}.{{ $boq_sub_item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control" name="unit_name" id="unit_name" placeholder="Enter Unit Name" value="{{ old('unit_name') }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="quantity" id="quantity" placeholder="Enter Quantity" value="{{ old('quantity') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="rate" id="rate" placeholder="Enter Rate" value="{{ old('rate') }}">
                            </div>
                        </div>
