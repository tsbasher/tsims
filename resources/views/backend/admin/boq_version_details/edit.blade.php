...
<section class="content">
    <div class="row">
        ...
        <div class="card card-body bg-gray-light">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" method="POST" id="boq_version_detail_form" action="{{ route('admin.boq_version_details.update', $boq_version_detail->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="package_id" placeholder="Package" name="package_id" required>
                                    ...
                                    <option value="{{ $package->id }}" @if(old('package_id',$boq_version_detail->package_id)==$package->id) selected @endif>{{$package->code}}.{{ $package->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="boq_version_id" placeholder="BOQ Version" name="boq_version_id" required>
                                    ...
                                    <option value="{{ $version->id }}" @if(old('boq_version_id',$boq_version_detail->boq_version_id)==$version->id) selected @endif>{{$version->code}}.{{ $version->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="scheme_option_id" placeholder="Scheme Option" name="scheme_option_id" required>
                                    ...
                                    <option value="{{ $option->id }}" @if(old('scheme_option_id',$boq_version_detail->scheme_option_id)==$option->id) selected @endif>{{ $option->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boq_part_id" id="boq_part_id" placeholder="Enter BOQ Part" required>
                                    ...
                                    <option value="{{ $boq_part->id }}" @if (old('boq_part_id',$boq_version_detail->boq_part_id)==$boq_part->id) selected @endif>{{$boq_part->code}}.{{ $boq_part->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boq_item_id" id="boq_item_id" placeholder="Enter BOQ Item" required>
                                    ...
                                    <option value="{{ $boq_item->id }}" data-sub_item="{{$boq_item->has_sub_items}}" @if (old('boq_item_id',$boq_version_detail->boq_item_id)==$boq_item->id) selected @endif>{{$boq_item->code}}.{{ $boq_item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="boq_sub_item_id" id="boq_sub_item_id" placeholder="Enter BOQ Sub Item">
                                    ...
                                    <option value="{{ $boq_sub_item->id }}" @if (old('boq_sub_item_id',$boq_version_detail->boq_sub_item_id)==$boq_sub_item->id) selected @endif>{{$boq_sub_item->code}}.{{ $boq_sub_item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="quantity" id="quantity" placeholder="Enter Quantity" value="{{ old('quantity',$boq_version_detail->quantity) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" name="rate" id="rate" placeholder="Enter Rate" value="{{ old('rate',$boq_version_detail->rate) }}">
                            </div>
                        </div>
