    ...
    <section class="content">
            <div class="row">
                    ...
                    <div class="card card-body bg-gray-light">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" action="{{ route('admin.department.update',$department->id) }}" enctype="multipart/form-data">
                            @csrf                            
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Department Code" value="{{ old('code',$department->code) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Internal Code" value="{{ old('internal_code',$department->internal_code) }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-check">
                                    ...
                                    @if (old('is_active',$department->is_active) == 1) checked @endif>
