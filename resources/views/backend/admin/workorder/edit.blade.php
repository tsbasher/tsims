        ...
        <div class="row">
            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    <h3 class="card-title">Edit Terms & Condition</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{ route('admin.terms_condition.update', $condition->id) }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="description" id="description"
                                        placeholder="Enter Terms & Condition Description" value="{{ old('description', $condition->description) }}">
                                </div>
                            </div>
                        </div>
