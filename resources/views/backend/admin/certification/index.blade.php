            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.certification.create') }}" class="btn btn btn-secondary"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body ">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <a href="{{ route('admin.certification.index') }}" class="btn btn-lg btn-default">
