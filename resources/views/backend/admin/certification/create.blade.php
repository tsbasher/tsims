...
@section('title', 'Crrtification Create')
@section('style')
    ...
    <section class="content">
            <div class="row">
                    ...
                    <div class="card card-body bg-gray-light">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" action="{{ route('admin.certification.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required class="form-control" name="name" id="name" placeholder="Enter Certificate Name" value="{{ old('name') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" name="id_number" id="id_number" placeholder="Enter ID Number" value="{{ old('id_number') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
