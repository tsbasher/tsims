    ...
    <section class="content">
            <div class="row">
                    ...
                    <div class="card card-body bg-gray-light">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" action="{{ route('admin.designation.update',$designation->id) }}" enctype="multipart/form-data">
                            @csrf                            
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Designation Code" value="{{ old('code',$designation->code) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            placeholder="Enter Internal Code" value="{{ old('internal_code',$designation->internal_code) }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-check">
                                    ...
                                    @if (old('is_active',$designation->is_active) == 1) checked @endif>
