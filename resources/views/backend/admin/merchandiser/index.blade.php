        ...
        <div class="row">
            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    <h2 class="card-title ">Merchandiser</h2>
                    <div class="card-tools">
                        <a href="{{ route('admin.merchandiser.create') }}" class="btn btn btn-secondary"><i
                            ...
                            <tbody>
                                @foreach ($merchandisers as $merchandiser)
                                    <tr>
                                        ...
                                        <td>{{ $merchandiser->customer->name }}</td>
                                        
                                        <td>
                                            @if ($merchandiser->is_active == 1)
                                        ...
                                        <td>
                                            <a href="{{ route('admin.merchandiser.edit', $merchandiser->id) }}"
                                                class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-sm btn-danger delete_record"
                                                data-url="{{ route('admin.merchandiser.destroy', $merchandiser->id) }}"><i
