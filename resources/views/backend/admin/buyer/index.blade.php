            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.buyer.create') }}" class="btn btn btn-secondary"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
                <div class="card-body ">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <a href="{{ route('admin.buyer.index') }}" class="btn btn-lg btn-default">
                            ...
                            <tbody>
                                @foreach ($buyers as $buyer)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.buyer.edit', $buyer->id) }}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-sm btn-danger delete_record" data-url="{{ route('admin.buyer.destroy', $buyer->id) }}"><i class="fas fa-trash"></i></a>
