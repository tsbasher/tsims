    ...
    <section class="content">
        <div class="row">
            ...
            <div class="card card-body bg-gray-light">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" method="POST" action="{{ route('admin.bank_account.store') }}"
                                    ...
                                    <select name="bank_id" id="bank_id" class="form-control select2" required>
                                        ...
                                        @foreach ($banks as $bank)
                                            <option value="{{ $bank->id }}" data-prefix="{{ $bank->internal_code }}"
                                                @if (old('bank_id') == $bank->id) selected @endif>{{ $bank->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="branch_address" id="branch_address" placeholder="Enter Branch Address">{{ old('branch_address') }}</textarea>
                                </div>
                            </div>
                        </div>
                         <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="bin"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="tin"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="routing_number"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" name="swiftcode" id="swiftcode"
                                        placeholder="Enter Swift Code" value="{{ old('swiftcode') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <select name="supplier_id" id="supplier_id" class="form-control select2">
                                        ...
                                        @foreach ($suppliers as $supplier)
                                            <option value="{{ $supplier->id }}"
                                                ...
                                                @if (old('supplier_id') == $supplier->id) selected @endif>{{ $supplier->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
