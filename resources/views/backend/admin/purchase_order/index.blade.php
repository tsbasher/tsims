            ...
            <div class="card card-body bg-gray-light">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.purchase_order.create') }}" class="btn btn btn-secondary"><i
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <label for="group_id" class="col-form-label">Supplier</label>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group ">
                                    <label for="po_date_from" class="col-form-label">From Date</label>
                                    
                                        <input type="text" class="form-control datepicker" name="po_date_from"
                                            id="po_date_from"
                                            value="{{ Request::has('po_date_from') ? Request::get('po_date_from') : '' }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <label for="po_date_to" class="col-form-label">To Date</label>
                                    
                                        <input type="text" class="form-control datepicker" name="po_date_to"
                                            id="po_date_to"
                                            value="{{ Request::has('po_date_to') ? Request::get('po_date_to') : '' }}">
                            ...
                            <tbody>
                                @foreach ($pos as $po)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>{{ $po->po_number }}</td>
                                        <td>{{ $po->work_order->order_number }}</td>
                                        <td>{{ $po->customer->name }}</td>
                                        <td>{{ $po->supplier->name }}</td>
                                        <td>{{ date('d F Y',strtotime($po->po_date)) }}</td>
                                        <td>{{ number_format($po->details->sum('total_price'),2) }}</td>
                                        
                                        <td>
                                            <a href="{{ route('admin.purchase_order.edit', $po->id) }}"
                                                class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-sm btn-danger delete_record"
                                                data-url="{{ route('admin.purchase_order.destroy', $po->id) }}"><i
                                                    class="fas fa-trash"></i></a>
                                            <a class="btn btn-sm btn-primary pl-2 pr-2"
                                                href="{{ route('admin.purchase_order.show', $po->id) }}"><i
